...
class FunnelLocs(object):
    ...
    EMAIL_INPT = (By.CLASS_NAME, "email")
    NEXT_STEP = (By.XPATH, "//button[contains(text(),'NEXT STEP')]")
    ...
    BILL_NEXT_BTN = (By.CLASS_NAME, "agreement")
    ...
    PRO_ANNUAL_RDIO = (By.ID, "professional-year")
    ...
    PAGES_INC_LBL = (By.ID, "paidsignup_FreePages")
